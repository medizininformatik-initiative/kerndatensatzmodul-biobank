# Hinweise zur Übersetzung - MII IG Kerndatensatz-Modul Biobank v2027.0.0-ballot
...
Übersetzte Seiten liegen unter `input/translations/de/pagecontent/` (gleicher Dateiname wie die englische Seite); Ressourcen-Übersetzungen als `.po`-Dateien unter `input/translations/de/`. Details: [`docs/recipes/add-translation.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-biobank/blob/main/docs/recipes/add-translation.md) in diesem Repository.
