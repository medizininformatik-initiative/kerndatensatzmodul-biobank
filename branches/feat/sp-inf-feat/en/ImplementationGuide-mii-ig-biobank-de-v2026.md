# MII ImplementationGuide Resource - MII IG Kerndatensatz-Modul Biobank v2027.0.0-ballot.rc2
...
```json
{
  ...
  },
  {
    ...
    "valueContactDetail" : {
      "telecom" : [{
        "system" : "email",
        "value" : "noemi.deppenwiese@uk-erlangen.de"
      }]
    }
  },
  {
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "MII EX Biobank Infektiositätsstatus",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-mii-vs-biobank-biosafety-level-snomedct.html"
      }],
      "reference" : {
        "reference" : "ValueSet/mii-vs-biobank-biosafety-level-snomedct"
      },
      "name" : "MII VS Biobank Biosafety-Level Einstufung [SNOMED CT]",
