# MII VS Biobank Probenart SCT - MII IG Kerndatensatz-Modul Biobank v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII VS Biobank Probenart SCT**

## ValueSet: MII VS Biobank Probenart SCT 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/ValueSet/mii-vs-biobank-probenart-sct | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2025-09-02 | *Maschinenlesbarer Name*:MII_VS_Biobank_Probenart_SCT |
...
Value Set for Sample Types (SNOMED CT) 
