# Versionierung - MII IG Kerndatensatz-Modul Biobank v2027.0.0-ballot.rc2
...
Das Modul **Biobank** folgt dem KDS-Schema der Kalender-Versionierung (CalVer) in einer SemVer-kompatiblen numerischen Form:
