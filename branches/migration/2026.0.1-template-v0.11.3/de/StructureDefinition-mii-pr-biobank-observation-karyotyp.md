# MII PR Biobank Observation Karyotyp - MII IG Kerndatensatz-Modul Biobank v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Biobank Observation Karyotyp**

## Ressourcenprofil: MII PR Biobank Observation Karyotyp 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/mii-pr-biobank-observation-karyotyp | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2025-09-02 | *Maschinenlesbarer Name*:MII_PR_Biobank_Observation_Karyotyp |

 
Der an einer Zelline oder einem Organiod festgestellte Karyotyo 
...
* Beispiel: [Karyotyp Organoid Lunge](Observation-KaryotypOrganoidLunge.md)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-biobank-observation-karyotyp.csv), [Excel](../StructureDefinition-mii-pr-biobank-observation-karyotyp.xlsx), [Schematron](../StructureDefinition-mii-pr-biobank-observation-karyotyp.sch) 
