# MII EX Biobank Rolle des Kontaktes - MII IG Kerndatensatz-Modul Biobank v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII EX Biobank Rolle des Kontaktes**

## Extension: MII EX Biobank Contact Role 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-biobank/StructureDefinition/KontaktRolle | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-02 | *Computable Name*:MII_EX_Biobank_KontaktRolle |

This extension allows specifying the role of the contact person in the specimen-managing organization, e.g., Principal Investigator, Director, etc.
...
Other representations of profile: [CSV](../StructureDefinition-mii-ex-biobank-kontaktrolle.csv), [Excel](../StructureDefinition-mii-ex-biobank-kontaktrolle.xlsx), [Schematron](../StructureDefinition-mii-ex-biobank-kontaktrolle.sch) 
