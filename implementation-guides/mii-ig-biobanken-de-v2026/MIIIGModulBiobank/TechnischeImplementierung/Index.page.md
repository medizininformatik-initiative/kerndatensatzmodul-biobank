...
|---------|---------------------|
| {{render:Warning}} | Für verpflichtende oder als must-support markierten Elemente sei an dieser Stelle auf die entsprechenden [Regeln der IPS](https://build.fhir.org/ig/HL7/fhir-ips/Must-Support-and-Obligations.html) verwiesen, die auch für diesen ImplementationGuide gelten. |