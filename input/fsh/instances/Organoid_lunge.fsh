...
* extension[modifikationen].extension[artDerModifikation].valueCodeableConcept = http://purl.obolibrary.org/obo/clo.owl#CLO:0037375 "derives from cell with knockout gene"
