...
* collection.bodySite = $sct-no-ver#14559000 "Structure of apex of left lung (body structure)"
* collection.method = $sct-no-ver#274319000 "Needle biopsy of lung (procedure)"
