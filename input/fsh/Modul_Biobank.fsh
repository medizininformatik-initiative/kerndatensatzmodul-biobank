...
* insert BuildElement(Biobank.Bioprobe.SonstigeEigenschaften,Freitextangabe weiterer Probeneigenschaften,String)
...
* insert BuildElement(Biobank.Bioprobe.Container.VerwendungAdditiv,	Ja/Nein Angabe ob ein Zusatzstoff verwendet wurde,boolean)
...
* insert BuildElement(Biobank.Bioprobe.Probenentnahme.EinstellungBlutversorgung,Zeitpunkt der Einstellung der Blutversorgung zur Probe. Kann zur Berechnung der warmen Ischaemiezeit verwendet werden.,dateTime)
...
* insert BuildElement(Biobank.Bioprobe.Probenentnahme.NuechternstatusDauer,Zeitliche Dauer der Nüchternheit vor der Probenentnahme,Quantity)
...
* insert BuildElement(Biobank.Bioprobe.Verarbeitungsprozess.VerwendungAdditive, Ja/Nein Angabe ob ein Zusatzstoff verwendet wurde,boolean)
