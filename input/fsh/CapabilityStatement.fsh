...
* insert SupportSearchParam(probenebene, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-probenebene, #token, #SHALL)
* insert SupportSearchParam(gehoert-zu, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-gehoert-zu, #reference, #SHALL)
* insert SupportSearchParam(anzahl-aliqouts, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-anzahl-aliquots, #number, #SHALL)
...
* insert SupportSearchParam(fasting-status, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-fasting-status, #token, #SHALL)
* insert SupportSearchParam(processing-temp, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-processing-temp, #quantity, #SHALL)
...
* insert SupportSearchParam(container-capacity, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-container-capacity, #quantity, #SHALL)
...
* insert SupportSearchParam(modifikationen, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-specimen-modifikationen, #composite, #SHALL)
...
* insert SupportSearchParam(_profile, http://hl7.org/fhir/SearchParameter/Resource-profile, #uri, #SHALL)
* insert SupportSearchParam(_source, http://hl7.org/fhir/SearchParameter/Resource-source, #uri, #SHALL)
* insert SupportSearchParam(beschreibung, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-organization-beschreibung, #string, #SHALL)
* insert SupportSearchParam(collection-setting, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-organization-collection-setting, #token, #SHALL)
* insert SupportSearchParam(collection-design, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-organization-collection-design, #token, #SHALL)
...
* insert SupportSearchParam(contact-rolle, https://www.medizininformatik-initiative.de/fhir/ext/modul-meta/SearchParameter/mii-sp-meta-organization-contact-rolle, #token, #SHALL)
//Contact?
