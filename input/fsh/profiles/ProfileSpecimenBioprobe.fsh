...
* collection.method.coding.system 1..1 MS
* collection.method.coding.code 1..1 MS
* processing.extension contains https://fhir.bbmri-eric.eu/StructureDefinition/miabis-sample-storage-temperature-extension named temperature-miabis 0..1 MS
* container 1.. MS
