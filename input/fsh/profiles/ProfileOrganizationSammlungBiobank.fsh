...
* extension[BeschreibungSammlung] ^definition = "Eine Freitextbeschreibung der Sammlung/Biobank, die z.B. in einer Suche angezeigt werden kann."
...
* alias ^definition = "Das Akronym oder der Kurztitel der Sammlung oder Biobank."
...
* partOf ^definition = "Verweist auf eine übergeordnete Sammlung oder Biobank, zu der diese gehört."
...
* identifier[bbmri-eric-id] ^definition = "Eindeutige Kennung im BBMRI-ERIC-Netzwerk."
...
* name ^definition = "Der vollständige Name der Sammlung oder Biobank."
