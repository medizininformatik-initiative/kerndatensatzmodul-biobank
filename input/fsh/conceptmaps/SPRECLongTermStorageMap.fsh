...
Title: "SPREC 4.0 Long-Term Storage Containertypen Mapping"
Usage: #definition
...
* insert AddMapping(702268003:840560000=256633009 , "General specimen container\, no additive\, non-sterile (physical object\): Has compositional material=Polypropylene (substance\)" , #wider)
...
* insert AddMapping(702268003, "General specimen container\, no additive\, non-sterile (physical object\)", #wider)
