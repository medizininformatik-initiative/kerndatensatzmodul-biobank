Instance: mii-cm-biobank-long-term-storage-sprec-sct
InstanceOf: http://hl7.org/fhir/StructureDefinition/ConceptMap
Title: "MII CM Biobank Long-Term Storage SPREC 4.0 SCT"
Usage: #definition
...
* group.source = "http://www.isber.org/sprec/long-term-storage"
* group.target = "http://snomed.info/sct"

* insert InitMapping(#A ,"PP tube")
* insert AddMapping(702269006:840560000=256633009 , "General specimen container\, no additive\, sterile (physical object\): Has compositional material=Polypropylene (substance\)" , #wider)
...
* insert AddMapping(702269006, "General specimen container\, no additive\, sterile (physical object\)", #wider)
...
* insert AddComment("Der SNOMED Code gilt nur für Tissue straws.")
