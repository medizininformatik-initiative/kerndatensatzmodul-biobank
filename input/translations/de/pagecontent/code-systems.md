...
Für [Body Site](ValueSet-mii-vs-biobank-body-structures-sct.html) kann neben SNOMED CT auch die International Classification of Diseases for Oncology, v.3, Topography [(ICD-O-3)](https://terminology.hl7.org/2.1.0/CodeSystem-icd-o-3.html) verwendet werden.

Die entsprechenden Value Sets wurden erstellt; die vollständige, automatisch generierte Liste aller Value Sets und CodeSysteme dieses Moduls findet sich in der [Artefakt-Übersicht](artifacts.html).
