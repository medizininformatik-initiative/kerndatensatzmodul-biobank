...
Diese Seite listet die FHIR-Profile des Moduls **Biobank**. Als
...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-biobank/blob/main/docs/recipes/add-a-profile.md) in diesem Repository sowie die
