...
This page lists the FHIR profiles of the **Biobank** module. As a
...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-biobank/blob/main/docs/recipes/add-a-profile.md) in this repository, and the MII naming
