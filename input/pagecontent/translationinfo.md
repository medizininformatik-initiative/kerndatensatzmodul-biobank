...
[`docs/recipes/add-translation.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-biobank/blob/main/docs/recipes/add-translation.md) in this repository.
