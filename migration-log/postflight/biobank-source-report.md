...
_Modus: `static` · Stand: 2026-08-27T17:27:38Z · Commit: `ec18029`_
...
_Interne FSH-Konstrukte (nicht in Σ): 24 rulesets, 1 invariants, 1 mappings._
...
| Inhalts-Seiten | 27 |
| Wörter gesamt | 5079 |
| Ø Wörter / Seite | 188,1 |
| Median Wörter / Seite | 128 |
| kürzeste / längste Seite | 40 / 1121 Wörter |
| doppelte Inhaltsblöcke | 4 |
| identische Seiten (Gruppen) | 0 |
| Bilder nicht referenziert | 3 von 4 |
| Beispiele nicht in Narrativen | 4 von 25 |
...
| Kennzahl | Wert |
|---|---|
| Hersteller-Lock-in | 90/100 (hoch) · 7,5 Direktiven/Seite |
| Standard-Terminologie-Anteil | 99 % (SNOMED CT, LOINC, UCUM) |
...
| Pflege-Kadenz | 53.1 Commits/Jahr · letzter Commit vor 30 Tagen |
...
| Narrative | 27 Inhalts-Seiten, Format source | Anzahl und Format der Erklärseiten (source = Plattformformat, target = IG-Publisher-Format). Das Format bestimmt, welche Werkzeuge die Seiten unverändert verarbeiten können. |
...
| Dependencies | 3 (2 floating) | Deklarierte Paket-Abhängigkeiten und ihr Pinning. Floating-Einträge folgen automatisch neuen Versionen und machen Builds weniger reproduzierbar — der Wert zeigt, wie reproduzierbar der aktuelle Stand ist. |
...
| QC-Regeln | 3 definiert | Anzahl der im Projekt definierten Qualitätsregeln (qc/custom.rules.yaml). Statisch wird nur die Definition gezählt; Verletzungen zeigt erst der Qualitätslauf eines Builds. |
| Metadaten/Config | id None, v2026.0.1 | Kern-Identität (id, Version) wie in sushi-config.yaml/package.json deklariert; die vollständigen Identitätsfelder stehen im Anhang. |
...
| name | de.medizininformatikinitiative.kerndatensatz.biobank | sushi-config.yaml / package.json |
...
- Dependency-Gesundheit: old-style=keine; THO direkt gepinnt=False, Extensions-Pack=False — **Injektionsrisiko: der Publisher lädt zur Buildzeit das JEWEILS NEUESTE Release**; externe Parents: 0
...
## Narrative-Seiten (27 Inhalt / 29 gesamt)
...
**Nicht referenzierte Bilder (3):** `implementation-guides/mii-ig-biobanken-de-v2026/images/2025-06-12_de_KDS-Abb_1.png`, `implementation-guides/mii-ig-biobanken-de-v2026/images/Probenebenen.PNG`, `implementation-guides/mii-ig-biobanken-de-v2026/images/UML_10_11_2025.png`

**Beispiele nicht in Narrativen eingebunden (4):** `AliquotgruppePlasma`, `AliquotBuffyCoat1`, `ProtocolCRISPRTP53`, `GewebeBiopsie`
